...
#    Updated: 2019/04/21 15:37:27 by jbashiri         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_PRINTF =	analise.c\
				...
				print_pointer.c\
				print_string.c
SRC =			functions_base_one.c\
				functions_base_three.c\
				functions_base_two.c\
				functions_check.c\
				functions_create_result.c\
				functions_free.c\
				functions_initialization.c\
				functions_record.c\
				functions_record_100.c\
				functions_swap.c\
				help.c\
				parser.c\
				print.c
...
$(CHECKER): $(LIBFT_PRINTF) $(OBJ_CH)
	@$(CC) $(FLAGS) $(OBJ_CH) $(LIBFT_PRINTF) $(INCLUDE) -o $(CHECKER)
	@echo "checker compiled"

$(PUSH_SWAP): $(LIBFT_PRINTF) $(OBJ_PU)
