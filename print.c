...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/01 10:50:12 by jbashiri          #+#    #+#             */
/*   Updated: 2019/04/01 10:50:16 by jbashiri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		out_two_mass_two(t_union *var, int size_a, int size_b, int num)
{
	int x;
